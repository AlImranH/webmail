            ...
            <div class="card mailboxlist-container" style="bottom: 0px; height: 80vh">
                ...
                <div class="card-body p-0">
                    <ul class="list-unstyled m-0 p-0">
                        <li>
                            <a href="" class="text-decoration-none px-1 border-bottom d-block active"><img src="{{asset('assets/images/icons/inbox.png')}}" alt=""> Inbox</a>
                        </li>
                        <li>
                            <a href="" class="text-decoration-none px-1 border-bottom d-block"><img src="{{asset('assets/images/icons/drafts.png')}}" alt=""> Drafts</a>
                        </li>
                        <li>
