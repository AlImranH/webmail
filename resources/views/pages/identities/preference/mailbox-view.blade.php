    ...
    <div class="w-100">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="preferences-tab" data-toggle="tab" href="#preferences" role="tab" aria-controls="preferences" aria-selected="true">Preferences</a>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="identities-tab" data-toggle="tab" href="#identities" role="tab" aria-controls="identities" aria-selected="false">Identities</a>
            </li>
            <li class="nav-item" role="presentation">
...
@section('content')
    <div class="tab-content w-100" id="myTabContent">
                    ...
                    <div class="card mailboxlist-container">
                        ...
                        <div class="card-body p-0">
                            <ul class="list-unstyled m-0 p-0">
                                <li>
                                    <a href="" class="text-decoration-none p-1 border-bottom d-block"> User Interface</a>
                                </li>
                                <li>
                                    <a href="{{url('/identities/preference-mailbox-view')}}" class="text-decoration-none p-1 border-bottom d-block active">Mailbox View</a>
                                </li>
                                <li>
        ...
        <div class="tab-pane fade show" id="identities" role="tabpanel" aria-labelledby="identities-tab">
            <div class="row mt-2" style="height: 80vh">
                <div class="col-md-3">
