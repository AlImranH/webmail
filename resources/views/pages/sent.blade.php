            ...
            <div class="card mailboxlist-container" style="bottom: 0px; height: 80vh">
                ...
                <div class="card-body p-0">
                    <ul class="list-unstyled m-0 p-0">
                        ...
                        <li>
                            <a href="{{url('/sent')}}" class="text-decoration-none px-1 border-bottom d-block active"><img src="{{asset('assets/images/icons/send.png')}}" alt=""> Sent</a>
                        </li>
                        <li>
                    ...
                    <ul class="p-0 m-0 list-unstyled message-list">
                        <li>
                            <a href="" class="d-flex justify-content-between text-decoration-none d-block px-2 border-bottom active">
                                <div>
                                    <small class="p-0 m-0">asifiqbal1537@gmail.com</small>
                                    <p>Re: testing</p>
                                </div>
                                <div>
                    ...
                    <div class="table-responsive">
                        <table class="table p-0 m-0" style="background: #EBEBEB">
                            ...
                            <tr class="m-0 p-0">
                                ...
                                <td class="px-1 py-0"><a href="">asifiqbal1537@gmail.com <i class="fas fa-user-tie"></i></a></td>
                            </tr>
                            <tr class="m-0 p-0">
